      ...
      <RevealOnScroll variant="slide-up" duration={800} threshold={0.1}>
        <div className="relative z-10 flex flex-col items-center">
            ...
            <h2 className="text-4xl md:text-6xl font-black text-center mb-6 tracking-tighter relative px-2">
                <span className="bg-clip-text text-transparent bg-gradient-to-br from-slate-900 via-slate-700 to-slate-800 dark:from-white dark:via-slate-200 dark:to-slate-400 drop-shadow-sm">
                    {title}
                </span>
